...
export default function Register() {
  ...
  >
    ...
    <h2 className="text-3xl font-bold mb-2 text-center text-gray-800">Join SkillSwap</h2>
    ...
    <div className="space-y-5">
      <div>
        ...
        <input
          ...
          className="w-full px-4 py-3 bg-white border border-gray-300 rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition shadow-sm"
          placeholder=""
          required
        />
        {errors.name && (
      ...
      <button
        type="submit"
        className="w-full py-3 px-4 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition-all shadow-md"
      >
        Register
      </button>
      ...
      <p className="mt-8 text-sm text-center text-gray-500">
        ...
        <span
          className="text-indigo-600 hover:text-indigo-500 cursor-pointer font-medium transition-colors"
